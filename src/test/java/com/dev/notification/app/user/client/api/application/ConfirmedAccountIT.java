...
@IntegrationIT
// TODO: Refatorar teste de integração para recuperar valor do REDIS.
class ConfirmedAccountIT {
    @Autowired
    private ConfirmedAccount confirmedAccount;
    ...
    private static final LocalDateTime EXPIRATION_DATE = LocalDateTime.of(2024, 12, 31, 23, 59, 59);
    private static final String OLD_EXPIRATION_DATE = "2024-01-01T23:59:59.000000000";
    private static final List<Parameter> PARAMETERS = List.of(new Parameter("hashcode", HASH));
...
//        final var hashToken = HashToken.create(prefix, EMAIL, HASH, EXPIRATION_DATE);
//        final var savedAccount = accountGateway.save(account);
//        hashTokenGateway.save(hashToken);
//        final var savedNotification = hashTokenGateway.get(prefix, EMAIL);
//        assertNotNull(savedAccount);
//        assertNotNull(savedNotification);
//        // When
//        confirmedAccount.execute(new ConfirmedHashDTO(HASH, EMAIL));
//        // Then
...
//        // When
//        final var exception = assertThrows(GatewayException.class, ()-> confirmedAccount.execute(new ConfirmedHashDTO(HASH, EMAIL)));
//        // Then
...
//
//        // When
//        final var exception = assertThrows(DomainException.class, () -> confirmedAccount.execute(new ConfirmedHashDTO("invalid_hash", EMAIL)));
//
//        // Then
//        assertNotNull(exception);
//        assertEquals(expectedErrorMessage, exception.getMessage());
...
//
//        // When
//        final var exception = assertThrows(DomainException.class, () -> confirmedAccount.execute(new ConfirmedHashDTO(HASH, EMAIL)));
//
//        // Then
//        assertNotNull(exception);
//        assertEquals(expectedErrorMessage, exception.getMessage());
